            ...
            <el-col class="nav" :span="10">
              <el-row>
                <el-col :span="3" v-for="(value,index) in data_list" :key="index">
                  ...
                  <router-link :to="value.link"  @click v-else>{{ value.title }}</router-link>
                </el-col>
              </el-row>
...
<!--                <router-link to="/cart">-->
<!--                  <b v-show="$store.state.cart_length">{{ $store.state.cart_length }}</b>-->
...
<!--                </router-link>-->
              ...
              <div class="nav-right-box" v-show="token">
                ...
                <!--                      <li>-->
                <!--                        我的账户-->
                <!--                        <img src="@/assets/back_1568185800.821227.svg" alt="">-->
                <!--                      </li>-->
                <!--                      <li>-->
                <!--                        我的订单-->
                <!--                        <img src="@/assets/back_1568185800.821227.svg" alt="">-->
...
export default {
  ...
  created() {
    ...
    //   .then((res) => {
    //
    //     let gwc = res.data.cart_data_list.length
    //
    //     this.get_nav_data();
    ...
    //       // alert(this.
    //       this.$store.state.cart_length = gwc
    //       let cart_length = this.$store.state.cart_length;
    //
  ...
  methods: {
    ...
    get_nav_data() {
      this.$axios.get(`${this.$settings.Host}/api/home/nav/`)
        .then((res) => {
          // alert("qwqw")
